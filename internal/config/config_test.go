...
func TestGenericDefaults(t *testing.T) {
	...
	checks := []struct {
		...
		{"Apps.CallTimeoutMax", cfg.Apps.CallTimeoutMax, Duration(90 * time.Second)},
		{"Apps.CallMaxInflight", cfg.Apps.CallMaxInflight, 16},
		...
		{"Auth.Device.MaxUploadBytes", cfg.Auth.Device.MaxUploadBytes, 209715200},
		{"Auth.Device.CodeRPM", cfg.Auth.Device.CodeRPM, 10},
		{"Auth.APIKeys.MaxTTL", cfg.Auth.APIKeys.MaxTTL, Duration(8760 * time.Hour)},
		{"Share.Enabled", cfg.Share.Enabled, false},
		{"Share.MaxTTL", cfg.Share.MaxTTL, Duration(720 * time.Hour)},
		{"Share.OpenRPM", cfg.Share.OpenRPM, 120},
		{"Share.MintRPM", cfg.Share.MintRPM, 30},
		{"Comments.GlobalRPM", cfg.Comments.GlobalRPM, 30},
		{"Comments.ArtifactRPM", cfg.Comments.ArtifactRPM, 10},
