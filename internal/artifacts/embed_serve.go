...
func (s *Service) ServeForEmbed(w http.ResponseWriter, r *http.Request, surface, ident string, ver *int32, caller, frameAncestors string) (served bool) {
	...
	case pgstore.TypeApp:
		...
		return s.serveAppRow(w, r, row, caller, frameAncestors, s.embedFilesBase(surface, caller, aid), "") == nil
...
func (s *Service) ServeForEmbedUser(w http.ResponseWriter, r *http.Request, surface, ident string, ver *int32, frameAncestors string) (served bool) {
	...
	switch row.ArtifactType {
	case pgstore.TypeApp:
		return s.serveAppRow(w, r, row, "", frameAncestors, s.embedFilesBaseUser(surface, aid), surface) == nil
	case pgstore.TypePackage:
