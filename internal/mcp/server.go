	...
	return []toolSpec{
		{
			...
			InputSchema: map[string]any{
				...
				"properties": map[string]any{
					...
					"allow_type_change":       map[string]any{"type": "boolean"},
					"expected_latest_version": map[string]any{"type": "integer"},
				},
			},
		},
		{
