  ...
  return (
    <div>
      <div className="px-6 pt-4">
        <h2 className="text-[14px] font-semibold text-neutral-900">Archived</h2>
      ...
      {err ? (
        <div className="mt-3 border-y border-rose-200 bg-rose-50 px-6 py-2 text-xs text-rose-700">
          error: {err}
        </div>
      ) : null}
      <ArchivedTable
